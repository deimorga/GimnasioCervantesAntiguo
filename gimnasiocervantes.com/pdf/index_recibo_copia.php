...
$alumno_concepto=getDatosFactura($_REQUEST['factura']);
$forma="No registra.";
if($alumno_concepto[0]['tipo_pago']==2){
$forma="Consignacion.";
}else{
$forma="Efectivo.";
}
//die ($alumno_concepto);
$total_pago=0;
$datos=getAlumnoBoletinId($_SESSION['alumno_pago']);
...
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0" style="font-size:14px;">
  ...
  <tr>
    <td colspan="2">Recibo de pago No. '.$_REQUEST['factura'].'</td>
  </tr>
  <tr>
    <td colspan="2"><h3>Datos Del Alumno.</h3></td>
  </tr>
  <tr>
    <td colspan="2">Identificaci&oacute;n: '.$_SESSION["alumno_pago"].'</td>
  </tr>
  <tr>
    <td colspan="2">Nombre: '.$datos["nombre_alumno"].'</td>
  </tr>
  <tr>
    <td colspan="2">Grupo: '.$datos["nombre_grupo"].'</td>
  </tr>
  <tr>
    <td>Fecha de Pago</td>
    <td align="right">'.$alumno_concepto[0]['fecha_pago'].'</td>
  </tr>
  <tr>
    <td>Forma de Pago</td>
...
for($i=0;$i<count($alumno_concepto);$i++){
  ...
  $html.='<tr>
    ...
    <td align="right">'.number_format($alumno_concepto[$i]['valor_cancelado'],2,',','.').'</td>
  </tr>';
}

$html.='<tr>
    <td>Total Factura</td>
    <td align="right">'.number_format($alumno_concepto[0]['valor_pago'],2,',','.').'</td>
  </tr>
  <tr>
