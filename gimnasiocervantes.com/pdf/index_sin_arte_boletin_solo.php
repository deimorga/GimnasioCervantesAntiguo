...
$mpdf=new mPDF('en-x',array(216, 330),'','',5,5,69,17,11,5);
/*('en-x',    // mode - default ''
...
$alumno=getAlumnoBoletinId($_REQUEST['identificacion']);
$anio="2015";
$ciudad="FACATATIVA";
...
for($i=0;$i<count($asignaturas);$i++){
	...
	$html.='  <tr>
		...
		<td align="center" width="39px">'.$p1['horas_justificadas'].'</td>
		<td align="center" width="46px">'.$p1['horas_injustificadas'].'</td>
