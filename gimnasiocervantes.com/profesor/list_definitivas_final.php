...
?>
	  <tr <? if(redondear($p5['calificacion_asignatura_final'])<3.7){?>style="background-color:#FF0"<? }else{?>style="background-color:#FFF;"<? }?>>
		...
		<td><?=$p5['desempenio_asignatura_final']." - ".$p5['calificacion_asignatura_final']?><? //redondear($prom)?></td>
	  </tr> 
	  <?
