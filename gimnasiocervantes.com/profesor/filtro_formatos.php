...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <h2>Seleccion de curso para impresion.</h2>
...
?>
        ...
        <table width="600px" cellpadding=5 cellspacing=0 border="0">
			<tr>
				<td align="center">
                <input class="button_send" name="informe_definitivas" id="informe_definitivar" type="button" value="GENERAR PDF" onClick="valida_formatos(this.form);">
                <input class="button_send" name="informe_definitivas_1" id="informe_definitivar_1" type="button" value="GENERAR EXCEL" onClick="valida_formatos_1(this.form);"></td>
			</tr>
        </table>