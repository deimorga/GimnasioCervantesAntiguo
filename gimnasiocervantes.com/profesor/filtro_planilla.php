...
if($_REQUEST['nueva_planilla']==1){
	...
	$_SESSION['planilla']=NULL;
}

if($_REQUEST['filtra_periodo_planilla']==1){
		$_SESSION['planilla']=NULL;
		$_SESSION['periodo_academico']=NULL;
...
<h2>Filtro de Periodo para Planilla de Actividades<? echo $grupo_asignatura['nombre_asignatura']." - ".$grupo_asignatura['nombre_grupo'];?></h2>
	<fieldset>
...
?>
    ...
    <input name="filtra_periodo_planilla" id="filtra_periodo_planilla" type="hidden" value="0">
	<input class="button_send" name="puente_usuario" id="puente_usuario" type="button" value="ACEPTAR" onclick="valida_seleccionar_periodo_planilla(this.form);">    
  ...
  <tr>
    ...
    if($_SESSION['grupo_asignatura']!="" && $_SESSION['periodo_academico']!=""){
		include('gestionar_planilla.php');
	}
	?></div></td>
  </tr>
</table>
