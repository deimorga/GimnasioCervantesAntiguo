...
<h2>Listado de Desempe&ntilde;os Bajos de los alumnos.</h2>
...
?>
        ...
        <table width="600px" cellpadding=5 cellspacing=0 border="0">
			<tr>
				<td align="center"><input class="button_send" name="informe_definitivas" id="informe_definitivar" type="button" value="FILTRAR LISTADO" onClick="FAjax('./profesor/list_desempenios_bajos.php','div_definitivas','','post');"></td>
			</tr>
        </table>
