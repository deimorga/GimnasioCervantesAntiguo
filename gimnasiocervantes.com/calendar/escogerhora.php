...
<!--Script para que la pagina se recarge y obtener actualizacion de campos que dependen de otros-->
       ...
       function ColocarHora(){ 
            ...
            opener.document.forms['frm_programacion_de_recogidas'][<?php echo $id;?>].value = varHora; 
            opener.document.forms['frm_programacion_de_recogidas'][<?php echo $id;?>].select() 
            opener.document.forms['frm_programacion_de_recogidas'][<?php echo $id;?>].focus() 
            close(); 
       } 
  </SCRIPT> 
