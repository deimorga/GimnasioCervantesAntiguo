...
* Supported dates:
* 1. Using native date functions (default): 1902-2037 (UNIX) or 1971-2037 (Windows)
...
// checking before enabling, as week number calulation works only if version > 4.1.0 [php function: date ("W")]
...
$linkstr=$this->mkUrl($this->actyear,$this->actmonth,$var);
  ////LINEA MODIFICADA POR DAVID PEREZ PARA ENVIAR EL NOMBRE DEL CAMPO Y HACER LA FUNCION MAS PARAMETRIZABLE
  /////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($this->javaScriptDay) $linkstr="<a href=\"javascript:".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var.",'".$this->nombre_campo."','".$this->nombre_formulario."')\">".$var."</a>";
...
$monthNavLink="<a href=\"".$this->urlNav.$glueNav.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&amp;"."campo=".$this->nombre_campo."&amp;"."formulario=".$this->nombre_formulario."\">";
$dayLink="<a href=\"".$this->url.$glue.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&amp;".$this->dayID."=".$day."\">".$day."&amp;"."campo=".$this->nombre_campo."&amp;"."formulario=".$this->nombre_formulario."</a>";
...
/*
********************************************************************************
PRIVATE getWeekNum() -> returns the week number, version > 4.1.0, unsupported by the ADOdb Date Library
********************************************************************************
*/
