...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <h2>Filtro cursos con direcci&oacute;n de grupo.</h2>
...
?>
        ...
        <table width="600px" cellpadding=5 cellspacing=0 border="0">
			<tr>
				<td align="center"><input class="button_send" name="informe_definitivas" id="informe_definitivar" type="button" value="FILTRAR LISTADO" onClick="FAjax('./profesor/list_alumnos_caso_especial.php','div_caso_especial','','post');">&nbsp;&nbsp;<input class="button_send" name="informe_inf" id="informe_inf" type="button" value="DESCARGAR INFORME CASOS ESPECIALES" onClick="window.open('./pdf/index_casos_especiales.php');"></td>
			</tr>
        </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="div_caso_especial"></div></td>
  </tr>
</table>