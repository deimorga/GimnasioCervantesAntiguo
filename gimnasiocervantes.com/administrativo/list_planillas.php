...
$asignatura=getPlanesGestores3($_SESSION['grupo_busqueda'],$_SESSION['director_busqueda'],$_SESSION['asignatura_busqueda'],$_SESSION['periodo_busqueda']);
...
$asignatura=getPlanesGestores3($_REQUEST['grupo'],$_REQUEST['director'],$_REQUEST['asignatura'],$_REQUEST['periodo_academico']);
}
?>
...
?>
        ...
        <table width="600px" cellpadding=5 cellspacing=0 border="0">
			<tr>
				<td align="center"><input class="button_send" name="informe_alumnos" id="informe_alumnos" type="button" value="FILTRAR LISTADO" onClick="FAjax('./administrativo/list_planillas.php','area_trabajo','','post');"></td>
			</tr>
        </table>
<?
...
?>
    ...
    <a href="#" onClick="FAjax('./profesor/gestionar_planilla.php?id_grupo_asignatura=<?=$asignatura[$i]['id_grupo_asignatura']?>&id_grupo=<?=$asignatura[$i]['id_grupo']?>&periodo_academico=<?=$asignatura[$i]['id_periodo_academico']?>&asignatura=<?=$asignatura[$i]['id_asignatura']?>&vista_plan=1','area_trabajo','','post');">Ver/Editar</a><? }else{?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><input type="button" value="DESCARGAR" class="button_send" onClick="window.open('./administrativo/list_planillas.php?descargar_planillas=1');"/></td>
  </tr>
</table>
<?
}
