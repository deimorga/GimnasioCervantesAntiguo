...
?>
	  <tr style="background-color:#CCC;">
		<td style="font-size:14px; border-right:0.1mm solid #220044;"><?=$alumnos_curso[$a]['nombre_alumno']?>
			...
			<td width="39px" style="border-right:0.1mm solid #220044;">PROM</td>
		  </tr>
<?	
...
?>
	  <tr <? if(redondear($prom)<3.7){?>style="background-color:#FF0"<? }else{?>style="background-color:#FFF;"<? }?>>
		...
		<td width="70px" style="border-right:0.1mm solid #220044;"><a href="#" onclick="FAjax('./administrativo/editar_nota_plan_gestor.php?identificacion=<?=$alumno['identificacion']?>&plan_gestor=<?=$asignaturas[$i]['id_plan_gestor']?>&califica=1&asignatura=<?=$asignaturas[$i]['id_asignatura']?>&periodo=1&tipo_asignatura=<?=$asignaturas[$i]['tipo_asignatura']?>','area_trabajo','','post');"><?=$p1['desempenio_asignatura']." ".$p1['calificacion_asignatura']?></a></td>

		<td width="70px" style="border-right:0.1mm solid #220044;"><a href="#" onclick="FAjax('./administrativo/editar_nota_plan_gestor.php?identificacion=<?=$alumno['identificacion']?>&plan_gestor=<?=$asignaturas2[$i]['id_plan_gestor']?>&califica=1&asignatura=<?=$asignaturas[$i]['id_asignatura']?>&periodo=2&tipo_asignatura=<?=$asignaturas[$i]['tipo_asignatura']?>','area_trabajo','','post');"><?=$p2['desempenio_asignatura']." - ".$p2['calificacion_asignatura']?></a></td>

		<td width="70px" style="border-right:0.1mm solid #220044;"><a href="#" onclick="FAjax('./administrativo/editar_nota_plan_gestor.php?identificacion=<?=$alumno['identificacion']?>&plan_gestor=<?=$asignaturas3[$i]['id_plan_gestor']?>&califica=1&asignatura=<?=$asignaturas[$i]['id_asignatura']?>&periodo=&tipo_asignatura=<?=$asignaturas[$i]['tipo_asignatura']?>3','area_trabajo','','post');"><?=$p3['desempenio_asignatura']." - ".$p3['calificacion_asignatura']?></a></td>

		<td width="70px" style="border-right:0.1mm solid #220044;"><a href="#" onclick="FAjax('./administrativo/editar_nota_plan_gestor.php?identificacion=<?=$alumno['identificacion']?>&plan_gestor=<?=$asignaturas4[$i]['id_plan_gestor']?>&califica=1&asignatura=<?=$asignaturas[$i]['id_asignatura']?>&periodo=4&tipo_asignatura=<?=$asignaturas[$i]['tipo_asignatura']?>','area_trabajo','','post');"><?=$p4['desempenio_asignatura']." - ".$p4['calificacion_asignatura']?></a></td>
