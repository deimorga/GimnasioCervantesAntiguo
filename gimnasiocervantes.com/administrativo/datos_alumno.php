...
if($_GET["nuevo"]==1){
	...
	if($alumno){
		...
		$folio=getConsecutivo($alumno["id_consecutivo"]);
		$grado_nombre=$alumno["nombre_grado"];
}
$grado=getGrados();
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right">Folio:&nbsp;&nbsp;&nbsp;&nbsp; <? //=completarCeros($folio['consecutivo'],3)?></td>
  </tr>
</table>
...
<table width="750px" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3">Grado: <?=$grado_nombre?></td>
  </tr>
  <tr>
...
?>
  ...
  <tr>
    <td>Lugar:</td>
    <td>Celular: <?=$familiares[$f]["tel_2"]?></td>
