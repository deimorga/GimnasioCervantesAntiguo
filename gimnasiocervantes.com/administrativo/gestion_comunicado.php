	...
	if($guarda_comunicado){
		$alumno=getAlumnosGrupo($_SESSION['grupo']);
			...
			for($i=0;$i<count($alumno);$i++){
				//echo "Entro!!!!";
				if($_POST[$alumno[$i]['identificacion']]){
...
<table width="100%" cellspacing=0 border="0">
  <tr>
    <td><div id="concepto"><? include_once("form_comunicado.php");?></div></td>
  </tr>
  <tr>
    <td valign="top"><div id="list_concepto"><? include_once("filtro_alumnos_grupo.php");?></div></td>
  </tr>
</table>
